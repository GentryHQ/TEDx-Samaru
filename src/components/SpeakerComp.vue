    ...
    data() {
        return {
            speakers: [
                ...
                {
                    name: 'Victor Iliya (Logik Tha Pro)', title: 'Content Creator and Music Artist', img: '/images/speakers/11.jpg',
                    topic: 'Unveiling Soon',
                    desc: 'Victor Iliya, widely recognized as Logik Tha Pro, is a multifaceted talent in the entertainment industry. Hailing from Kaduna State, Nigeria, he is a distinguished producer, sound engineer, content creator, and artist specializing in short-form music comedy. Currently, he is in his final year at the prestigious Kaduna State University, where he is pursuing a degree in Industrial Chemistry. Driven by an unyielding passion for music and comics, Logik Tha Pro has dedicated himself to honing his craft, achieving a level of quality and originality that sets him apart. His innovative approach and unique style in creating short-form music comedy have garnered him a significant following and made a substantial impact on a broad audience. As a sensation in the music comedy and content creation scene, Logik Tha Pro boasts a following of over 100,000 dedicated fans on Instagram. His engaging and creative content has reached and influenced more than 1 million people, solidifying his reputation and setting the stage for continued success.',
                   
                },
                {
                    name: 'Dr Amina Sambo-Magaji', title: 'Senior Startup Advisor', img: '/images/speakers/7.jpeg',
                    topic: 'Unveiling Soon',
                    desc: 'Dr Amina Sambo-Magaji, PhD, is a veteran technocrat, tech policy developer and senior startup advisor with over 21 years of experience. She is a pioneer figure in the Nigerian startup and innovation ecosystem, who has designed, managed and implemented several programs and projects for over 100,000 founders and business owners across Nigeria. Dr Sambo - Magaji has been pivotal in building Nigeria IT Talent and advocating for the adoption of emerging technologies for solving socioeconomic challenges. She is largely focused on building sustainable systems and creating opportunities for youth (especially women and young girls) in tech to excel. Dr Sambo - Magaji holds a first-class degree in Computer Science from the Abubakar Tafawa Balewa University (ATBU), a master’s with Distinction and PhD (Artificial Intelligence) from the Robert Gordon University, Scotland. She currently leads the Digital Literacy and Capacity Development Department at NITDA. Dr Sambo - Magaji has published and presented her work in several international conferences and journals. In her academic pursuit, at the Advance Centre of Excellence on Technology Enhanced Learning (NOUN-ACETEL) she is part of the team that pioneered MSc and PhD in AI. Additionally, Dr Sambo - Magaji is a United States Distinguished Humphrey Leadership Fellow. She is a recipient of several national',
                   
                },
                {
                    name: 'Ebuka Mordi', title: 'Filmmaker and Photographer', img: '/images/speakers/9.jpeg',
                    topic: 'Unveiling Soon',
                    desc: 'As a self-taught filmmaker and photographer, Mordi has been honing his craft and leaving an indelible mark on the creative world since 2014. With a passion for visual storytelling and a keen eye for capturing compelling moments, he has established himself as a force to be reckoned with in the industry. Mordi"s work has been widely recognized and celebrated, gracing the pages of numerous prestigious blogs and magazine. His talent and dedication has earned him the honor of being a Creative Resident with Adobe, where he has contributed invaluable insights and expertise on the development of Lightroom, a software he deeply cherishes. Beyond his artistic pursuits, Ebuka Mordi is a celebrated educator, serving as a top teacher on Skillshare, where he shares his knowledge and inspires aspiring creatives through the comprehensive courses on photography. His commitment to nuturing talents has also led to his role as an Adobe Express Ambassador and an Agora Panalist, platforms where he continues to inspire and empower others. With a portfolio that spans diverse genres and mediums Mordi continues to push boundaries and redefine what it means to be a modern-day creative. His unwavering dedication to his craft, combined with his ability to inspire and educate, has solidified his reputation as a true visionary in the world of filmmaking and photography',
