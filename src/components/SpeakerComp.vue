    ...
    data() {
        return {
            speakers: [
                ...
                {
                    name: 'Professor Sahalu Junaidu Balarabe', title: 'Professor', img: '/images/speakers/5.jpg',
                    topic: 'Unveiling Soon',
                ...
                {
                    name: 'Angela Omeiza', title: 'CEO J Blood Match', img: '/images/speakers/5.jpg',
                    topic: 'Unveiling Soon',
                ...
                {
                    name: 'Hafsat Abdullahi', title: 'Spoken Word Artist', img: '/images/speakers/5.jpg',
                    topic: 'Unveiling Soon',
